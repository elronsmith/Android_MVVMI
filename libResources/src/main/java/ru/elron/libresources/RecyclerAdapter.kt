...
open class RecyclerAdapter<T: AObservable>(
    var observableList: ArrayList<T> = ArrayList(),
    var holderBuilderArray: SparseArrayCompat<ViewHolderBuilder> = SparseArrayCompat<ViewHolderBuilder>()) : ARecyclerAdapter() {
